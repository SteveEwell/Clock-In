...
@interface WidgetBarcodeRenderer()
...
@implementation WidgetBarcodeRenderer
...
-(UIImage *)drawBarcodeAsImage:(NSString *)input {
    ...
    for (int i = 0; i < binary.length; i++) {
        ...
        if ([character isEqualToString:@"1"]) {
            CGContextMoveToPoint(context, padding * 3, 5);
            CGContextAddLineToPoint(context, padding * 3, size.height - (5));
